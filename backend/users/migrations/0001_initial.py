# Generated by Django 5.1.7 on 2025-03-15 02:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('poor', '贫困户'), ('social', '社会力量'), ('admin', '管理员')], default='poor', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(limit_choices_to={'user_type': 'social'}, on_delete=django.db.models.deletion.CASCADE, related_name='social_profile', to='users.user')),
            ],
        ),
    ]
